...
export const toolDefinition = {
  name: 'site_get_page',
  description:
    'Get page details from a Baklib site by site ID and page ID. When the response includes template_variables, rich-text fields are returned as BKE Markdown (body_format=markdown).',
  inputSchema: {
    type: 'object',
    properties: {
      site_id: {

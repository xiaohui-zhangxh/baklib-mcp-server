...
export const toolDefinition = {
  ...
  description:
    'List pages in a Baklib site with optional filtering and pagination. With include_details, template_variables rich fields are returned as BKE Markdown (body_format=markdown).',
  inputSchema: {
    type: 'object',
    properties: {
      site_id: {

/**
 * Site Delete Page Tool
 * 
 * Delete a page from a Baklib site.
 * API: DELETE /sites/{site_id}/pages/{page_id}
 */
...
export const toolDefinition = {
  ...
  description: 'Delete a page from a Baklib site.',
  inputSchema: {
    type: 'object',
    properties: {
      site_id: {
...
export async function handleTool(args) {
  ...
  await makeApiRequest(`/sites/${site_id}/pages/${page_id}`, 'DELETE', { query });
  return { success: true };
}

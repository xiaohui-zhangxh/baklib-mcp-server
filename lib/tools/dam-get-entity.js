...
export async function handleTool(args) {
  ...
  const result = await makeApiRequest(`/dam/entities/${id}`, 'GET', { query });
  return {
    success: true,
    data: result.data,
